...
<script type="text/javascript">
    ...
    function showEditModel(cid) {
        ...
        $.ajax({
            ...
            success: function (category) {
                $('#recipient-name').val(category.name);
                $('#recipient-des').val(category.des);
                $('#recipient-id').val(category.id);
                var tempStr = '#recipient-parent option[value='+category.parentid+']';
    ...
    function cleanEditForm() {
        ...
        var tempStr = '#recipient-parent option';
        $(tempStr)[0].selected = true;
    }
</script>
<style type="text/css">
...
<div class="modal fade" id="myModal" onsubmit="return " role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form id="model-form" action="/category/saveOrUpdate" method="post">
